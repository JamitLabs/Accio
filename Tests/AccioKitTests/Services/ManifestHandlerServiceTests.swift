...
class ManifestCreatorServiceTests: XCTestCase {
    ...
    func testLoadManifest() {
        resourcesLoaded([manifestResource, xcodeProjectResource, exampleSwiftFile]) {
            ...
            XCTAssert(try! foundFrameworks[0].xcodeProjectPaths().contains { $0.contains("HandySwift.xcodeproj") })
            ...
            XCTAssert(try! foundFrameworks[1].xcodeProjectPaths().contains { $0.contains("HandyUIKit.xcodeproj") })
            ...
            XCTAssert(try! foundFrameworks[2].xcodeProjectPaths().contains { $0.contains("Imperio.xcodeproj") })
            ...
            XCTAssert(try! foundFrameworks[3].xcodeProjectPaths().contains { $0.contains("MungoHealer.xcodeproj") })
            ...
            XCTAssert(try! foundFrameworks[4].xcodeProjectPaths().contains { $0.contains("SwiftyBeaver.xcodeproj") })
